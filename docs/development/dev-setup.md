...
├── src/
│   └── feedback_triage/  # Main package code
│       ├── __init__.py
...
| Command | Equivalent |
| --- | --- |
| `fta-doctor` | `python scripts/doctor.py` |
| `fta-git-doctor` | `python scripts/git_doctor.py` |
| `fta-env-doctor` | `python scripts/env_doctor.py` |
| `fta-repo-doctor` | `python scripts/repo_doctor.py` |
| `fta-clean` | `python scripts/clean.py` |
| `fta-env-inspect` | `python scripts/env_inspect.py` |
| `fta-repo-stats` | `python scripts/repo_sauron.py` |
| `fta-dashboard` | `hatch run dashboard:serve` |

All arguments are forwarded: `fta-git-doctor --json` works as expected.
