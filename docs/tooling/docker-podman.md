...
Consistent deploy/runtime environment and local parity.

### What it is

OCI container engines for building/running application images.
...
- Building/running service containers locally or in CI.

**Do not use this tool for:**

- Replacing tests, observability, or business workflow orchestration.
