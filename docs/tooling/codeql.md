...
Semantic code scanning in GitHub CI.

### What it is

Semantic code analysis engine integrated with GitHub code scanning.
...
- PR validation for security regressions.

**Do not use this tool for:**

- Dependency update automation or infrastructure-level hardening checks.
