...
Keeps the API boundary explicit while hosting backend business logic and the web shell.

### What it is

Python API framework based on Python type hints; built for APIs.
...
- Defining routes, request/response models, middleware, and API contracts.

**Do not use this tool for:**

- Frontend rendering/layout, chart hover state, dashboard drag UI, or client-only interactivity.
