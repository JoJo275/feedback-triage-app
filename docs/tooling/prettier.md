...
Normalizes Markdown formatting (including tables) and reduces noisy doc diffs.

### What it is

Opinionated formatter used for Markdown formatting consistency.
...
- Docs-heavy edits or when preparing Markdown for review.

**Do not use this tool for:**

- Replacing language-aware formatters (for example Ruff) or semantic documentation review.
