...
Catch spelling mistakes in code/docs/config.

### What it is

Spelling and typo detection tools for code/docs/config text.
...
- Content edits across docs, code, and workflow files.

**Do not use this tool for:**

- Semantic documentation review or technical correctness verification.
