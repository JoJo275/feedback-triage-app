...
- **Tool name:** CSS variables / design tokens
- **Status:** Active
- **Layer:** Frontend
...
Keeps theme decisions consistent and easier to evolve.

### What it is

Named CSS values for color, spacing, radius, and shadow decisions.
...
- Use for brand color systems, density, and semantic styling primitives.

**Do not use this tool for:**

- One-off, untracked styling values scattered across unrelated components.
