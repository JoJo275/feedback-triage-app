...
Keeps tiny local UI state simple and explicit.

### What it is

React hook for small local component state.
...
- Use for isolated UI state such as toggles, selected tabs, and simple form interactions.

**Do not use this tool for:**

- Complex multi-action state transitions or cross-component shared state.
