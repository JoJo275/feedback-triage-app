...
Produces SPDX/CycloneDX artifacts for supply-chain transparency and compliance.
...
| Source files | . |
| Generated output | SBOM artifacts in workflow runs |
| Tests | tests/ |
...
- Use for release governance and dependency inventory snapshots.

**Do not use this tool for:**

- Replacing vulnerability scanning, policy enforcement, or dependency update workflows.
