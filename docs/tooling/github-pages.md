...
- **Tool name:** GitHub Pages
- **Status:** Active
- **Layer:** Docs
- **Scope:** Documentation hosting
- **Owner:** Engineering
...
Publishes MkDocs documentation on pushes to main.

### What it is

Static hosting platform for project documentation site output.
...
- When docs deployment workflow runs on main or manual trigger.

**Do not use this tool for:**

- Serving dynamic application APIs or runtime backend content.
