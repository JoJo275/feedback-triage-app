...
- **Tool name:** markdownlint-cli2
- **Status:** Active
- **Layer:** Docs
- **Scope:** Documentation linting
- **Owner:** Engineering
...
Catches Markdown authoring issues beyond formatter output.

### What it is

Markdown linter for style and structural consistency checks.
...
```bash
pre-commit run markdownlint-cli2 --hook-stage manual --all-files
```
...
- Optional docs lint passes and pre-merge docs cleanups.

**Do not use this tool for:**

- Replacing strict docs builds or content-level technical review.
