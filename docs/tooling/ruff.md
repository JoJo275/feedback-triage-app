...
Fast lint + format baseline for Python code quality.
...
- Before committing any Python/doc tooling edits touching linted files.

**Do not use this tool for:**

- Replacing static typing, security analysis, or runtime behavior tests.
