...
- **Tool name:** Jinja2 email templates
- **Status:** Active
- **Layer:** Cross-repo
- **Scope:** Email templating
- **Owner:** Engineering
...
Keeps backend-generated transactional email content consistent and maintainable.

### What it is

Python templating layer for HTML/text transactional email templates.
...
- Use for transactional email rendering flows.

**Do not use this tool for:**

- Main frontend application pages or interactive SPA route rendering.
