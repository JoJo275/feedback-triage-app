...
- **Tool name:** Tailwind CSS (Standalone CLI)
- **Status:** Active
- **Layer:** Frontend
...
Fast, consistent styling primitives for app UI without adding a Node build dependency for CSS compilation.

### What it is

Utility-first CSS framework compiled through the standalone Tailwind binary.
...
| Source files | web/ |
| Generated output | src/feedback_triage/static/css/ |
...
- Building or iterating on the v2 stylesheet pipeline.

**Do not use this tool for:**

- Replacing design-system thinking; utility classes alone are not a design system.
