...
Lightweight client state in dashboard pages.

### What it is

Lightweight declarative client-state layer for server-rendered pages.
...
- Local state toggles/search UI behavior in templates.

**Do not use this tool for:**

- Full application-wide state management with complex data synchronization needs.
