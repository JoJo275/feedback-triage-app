...
Browser-level smoke/e2e checks to prevent critical flow regressions.

### What it is

End-to-end browser automation framework for modern web apps.
...
- Frontend shell/page flow changes and UI parity checks.
