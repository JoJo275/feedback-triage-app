...
Build backend and versioning from git tags.

### What it is

Python build backend plus git-tag-based versioning plugin.
...
- Building distributions or packaging in CI/image builds.

**Do not use this tool for:**

- Runtime dependency management or manual version stamping outside the tag-driven release flow.
