...
Automates trusted publishing in tagged release workflows.

### What it is

GitHub Action for publishing built Python distributions to PyPI.
...
- On release tags and release workflow dispatch.

**Do not use this tool for:**

- Building distributions or changelog generation itself.
