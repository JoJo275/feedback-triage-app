...
Lets teams build reusable dashboard widgets, forms, modals, tables, cards, and charts.
...
- Use for interactive frontend UI.

**Do not use this tool for:**

- Backend logic and direct database access.
