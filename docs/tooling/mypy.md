...
Static type safety for src/feedback_triage/.
...
- Public API changes, schema/model changes, refactors.

**Do not use this tool for:**

- Runtime input validation or behavioral/regression test coverage.
