...
- **Tool name:** FastAPI + Jinja2 (dashboard app)
- **Status:** Active
- **Layer:** Operations
- **Scope:** Operations UI
- **Owner:** Engineering
...
Internal environment dashboard server-rendered UI.

### What it is

Server-rendered dashboard stack for internal environment tooling.
...
- Working in tools/dev_tools/env_dashboard/.

**Do not use this tool for:**

- Replacing the main frontend runtime where SPA-style component composition is required.
