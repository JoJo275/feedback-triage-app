...
Single source of truth for Python environment and lockfile management.

### What it is

Python environment, dependency, and lockfile manager.
...
- Ad-hoc package installs or unmanaged virtualenv workflows that bypass uv.lock.
