...
Validates request/response models and keeps API contracts clear and typed.

### What it is

Python data validation and serialization layer used by FastAPI.
...
- Defining API schemas and internal typed data models.

**Do not use this tool for:**

- Long-term DB schema migrations or relational schema evolution (use Alembic for those).
...
This tool owns no durable product truth. It validates API and model boundaries.
