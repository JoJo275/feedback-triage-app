...
Secret scanning for commits/history.

### What it is

Secret scanning tool for git history and staged content.
...
- Before pushing when handling env/config/secrets-adjacent changes.

**Do not use this tool for:**

- Runtime secret management, key rotation, or credential storage policy enforcement.
