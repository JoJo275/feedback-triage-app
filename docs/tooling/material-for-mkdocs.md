...
Site theme and docs UX features.

### What it is

Theme and UX extension package for MkDocs.
...
- Navigation/theme/layout changes in docs site.

**Do not use this tool for:**

- Serving as a frontend framework for product application pages.
