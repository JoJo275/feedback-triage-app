...
- **Tool name:** GitHub Dependency Review
- **Status:** Active
- **Layer:** CI
- **Scope:** CI security
- **Owner:** Engineering
...
Prevents vulnerable or risky dependency changes from landing in main.

### What it is

GitHub Action that compares dependency graph changes in pull requests.
...
- Runtime container or application vulnerability scanning.
