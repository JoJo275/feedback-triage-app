...
│       ├── main.py             # Entry points (fta, fta-doctor, etc.)
│       ├── scripts_cli.py      # Script entry points (fta-git-doctor, etc.)
...
| ------------------------------------------- | ------------------------------------- | ---------------------------------------- |
| `src/feedback_triage/`            | Package source code                   | Everything — no package to import        |
| `src/feedback_triage/__init__.py` | Package marker, exports version       | Package won't be recognized              |
...
| Path | Purpose | What Breaks If Removed |
| --- | --- | --- |
| `src/feedback_triage/scripts_cli.py` | Entry point wrappers for all scripts | `fta-*` script commands unavailable |
| `src/feedback_triage/main.py` | Core entry points (fta, fta-doctor) | `fta` and core commands unavailable |
...
├── main.py         # Core entry points (fta, fta-doctor, fta-start)
├── scripts_cli.py  # Script entry points (fta-git-doctor, fta-dashboard, etc.)
...
See the project spec v1.0 at [docs/project/spec/spec-v1.md](project/spec/spec-v1.md)
