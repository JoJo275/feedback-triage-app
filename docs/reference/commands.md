...
<!-- Generated: 2026-04-29 14:58:36 UTC -->
...
!!! info "Generation details"
    ...
    | **Timestamp** | 2026-04-29 14:58:36 UTC |
...
| `task check` | Run lint + fmt:check + typecheck + test |
| `task default` | List available tasks |
| `task deptry` | Dependency hygiene (unused / missing / transitive) |
| `task dev` | Run the FastAPI app with auto-reload |
...
| Run lint + fmt:check + typecheck + test | `task check` |
...
| Run the FastAPI app with auto-reload | `task dev` |
